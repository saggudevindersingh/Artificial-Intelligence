...
with open(r"C:\data\Artificial-Intelligence\Images\Set of Fruits.png", "rb") as image:
    image_data = image.read()

response = client.analyze(image_data=image_data, visual_features=[VisualFeatures.OBJECTS])
